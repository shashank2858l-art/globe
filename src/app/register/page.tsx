    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#0a0a0a]">
      <div className="w-full max-w-md p-8 rounded-2xl bg-gradient-to-b from-zinc-900/50 to-zinc-900/20 border border-zinc-800/50 backdrop-blur-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 rounded-lg bg-white hover:bg-gray-100 text-gray-900 font-medium transition-colors disabled:opacity-50 mb-6"
        >
          {isGoogleLoading ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setFormData({ ...formData, username: e.target.value.toLowerCase().replace(/\s/g, '_').replace(/[^a-z0-9_]/g, '') })}
              className="w-full px-4 py-3 rounded-lg bg-zinc-900 border border-zinc-800 text-white placeholder-zinc-500 focus:outline-none focus:border-blue-500 transition-colors"
              placeholder="johndoe"
              required
            />
